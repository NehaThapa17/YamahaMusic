		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sales Order",
									"targetURL": "#yamahamusicsocreatesoproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"yamahamusicsocreatesoproject-display": {
								"semanticObject": "yamahamusicsocreatesoproject",
								"action": "display",
								"description": "A Fiori application to create SO.",
								"title": "Sales Order",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=yamahamusic.so.createso.project",
									"url": sap.ui.require.toUrl("yamahamusic/so/createso/project")
								}
							}
						}
					}
